...
| User Story ID | Title                          | Description                                                                                                 | Acceptance Criteria (Criterios de aceptación)                                                                                                                                                                  | Epic          |
|---------------|--------------------------------|-------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------|
| US-01         | Registro de Usuario            | Como usuario quiero registrarme en la plataforma para acceder a sus funcionalidades.                       | Given el usuario está en la página de registro, When ingresa datos válidos y envía, Then se crea la cuenta; Given datos erróneos, When envía, Then muestra errores.                                          | EP01          |
| US-02         | Inicio de Sesión              | Como usuario quiero iniciar sesión para acceder a mi cuenta.                                              | Given usuario en pantalla de login, When ingresa credenciales válidas, Then accede; When inválidas, Then muestra mensaje de error.                                                                             | EP01          |
| US-03         | Cierre de Sesión              | Como usuario quiero cerrar sesión para proteger mi cuenta.                                                | Given usuario logueado, When selecciona "Cerrar sesión", Then la sesión termina y redirige a la página inicial.                                                                                                | EP01          |
| US-04         | Recuperación de Contraseña    | Quiero recuperar mi contraseña en caso de olvido para volver a acceder.                                   | Given opción recuperación, When correo registrado ingresado, Then envía enlace; When correo no registrado, Then muestra error.                                                                                | EP01          |
| US-05         | Acceso a Landing Page         | Como usuario quiero entrar a la Landing Page y visualizarla correctamente.                                | Given visita página, When carga, Then muestra contenido sin errores.                                                                                                                                          | EP02          |
| US-06         | Ver Información General       | Como usuario quiero leer toda la información general sobre el producto en la Landing Page.                | Given usuario en landing page, When navega, Then la información es legible y accesible.                                                                                                                      | EP02          |
| US-07         | Botón de Acción               | Como usuario quiero encontrar fácilmente el botón que me lleve al registro o uso del aplicativo.          | Given usuario en landing page, When busca acción, Then encuentra botón visible y funcional.                                                                                                                  | EP02          |
| US-08         | Traducción de la Landing Page | Como usuario quiero ver traducida la página web según mis necesidades.                                    | Given usuario cambia idioma, When selecciona, Then página se traduce correctamente.                                                                                                                          | EP02          |
| US-09         | Pestaña de Perfil             | Como usuario quiero un perfil donde ingresar mi información personal y documentos.                        | Given acceso a "Mi Perfil", When perfil existente, Then puede modificar; When sin perfil, Then puede crear.                                                                                                     | EP03          |
| US-10         | Crear Perfil                  | Como usuario quiero crear un perfil ingresando mis datos personales.                                     | Given usuario crea perfil, When datos válidos, Then se crea; When faltan campos, Then solicita completar.                                                                                                     | EP03          |
| US-11         | Modificar Perfil              | Como usuario quiero modificar la información de mi perfil.                                              | Given perfil, When modifica con datos válidos, Then se actualiza; When datos inválidos, Then muestra error.                                                                                                   | EP03          |
| US-12         | Cargar Documentos            | Como usuario quiero cargar documentos personales en mi perfil.                                         | Given usuario en perfil, When carga documentos, Then se suben; When reemplaza, Then actualiza.                                                                                                               | EP03          |
| US-13         | Registrar Ítem con QR/RFID    | Como usuario quiero registrar ítems con etiquetas QR o RFID para identificar.                          | Given ítem y etiqueta, When escanea, Then registro correcto.                                                                                                                                                 | EP02          |
| US-14         | Escanear Entrada/Salida      | Como usuario quiero escanear ítems al ser usados para actualizar inventario automáticamente.            | Given ítem registrado, When escanea para uso, Then stock se actualiza descontando unidad.                                                                                                                   | EP02          |
| US-15         | Actualización Automática de Stock | Como sistema quiero actualizar stock tras movimientos para mantener datos precisos.                   | Given venta o devolución, When finaliza proceso, Then stock ajustado automáticamente.                                                                                                                        | EP02          |
| US-16         | Generar Historial de Uso      | Como usuario quiero consultar historial de uso para auditorías.                                       | Given insumo seleccionado, When consulta historial, Then muestra transacciones y usos.                                                                                                                      | EP02          |
| US-21         | Recibir Alerta de Temperatura | Como usuario quiero recibir alertas si la temperatura está fuera de rango.                            | Given sensores monitorean, When anomalía detectada, Then alerta enviada al responsable.                                                                                                                     | EP04          |
| US-22         | Alerta de Insumos Próximos a Vencer | Como usuario quiero recibir notificaciones para insumos próximos a vencer.                         | Given inventario con fecha de vencimiento, When se aproxima fecha, Then se genera notificación.                                                                                                              | EP04          |
| US-23         | Alerta de Bajo Stock         | Como usuario quiero recibir alertas cuando el stock esté bajo para realizar reposición.               | Given nivel de stock bajo, When umbral rebasado, Then alerta automática enviada.                                                                                                                           | EP04          |
| US-24         | Configurar Tipos y Canales de Alerta | Como usuario quiero configurar qué alertas recibir y por qué canal.                                  | Given opciones de alerta, When usuario configura preferencias, Then sistema envía alertas según configuración.                                                                                                | EP04          |
| US-33         | Generar Reporte de Inventario | Como administrador quiero generar reportes descargables del estado del inventario.                   | Given administrador accede a reportes, When selecciona "Inventario Actual", Then genera y descarga PDF o Excel; Given productos críticos, Then resaltados en reporte.                                      | EP05          |
| US-34         | Dashboard de Métricas de Uso | Como administrador quiero visualizar un dashboard con estadísticas para análisis.                    | Given administrador en dashboard, When consulta gráficos, Then muestra tendencias y detalles en tiempo real.                                                                                               | EP05          |
| US-35         | Reporte de Inspecciones y Calidad | Como coordinador quiero reportes históricos para control de calidad.                                 | Given coordinador en módulo de reportes, When filtra por fecha, Then muestra inspecciones filtradas con estado detallado.                                                                                     | EP05          |
| US-36         | Exportar Reportes Automáticos | Como administrador quiero configurar envíos automáticos periódicos de reportes por correo.           | Given activación de reportes, When llega fecha, Then envía automáticamente; Cuando se cancela, Entonces detiene envíos futuros.                                                                              | EP05          |
| US-29         | Selección de Laboratorio     | Como inspector quiero seleccionar un laboratorio para registrar productos e inspecciones.            | Given dropdown disponible, When selecciona laboratorio, Then puede continuar; Cuando no hay laboratorios, Then muestra mensaje y opción de alerta futura.                                                   | EP06          |
| US-30         | Subir Producto               | Como inspector quiero registrar un producto para inspección de calidad.                             | Given laboratorio seleccionado y datos válidos, When envía formulario, Then producto registrado con estado pendiente; Cuando faltan datos, Then validaciones mostradas.                                   | EP06          |
| US-31         | Inspección de Calidad        | Como técnico quiero inspeccionar productos y registrar resultados para aprobar o rechazar.          | Given producto pendiente, When inspecciona y marca resultado, Then estado cambia; Cuando hay incidencias, Then notifica investigador y cambia estado.                                                    | EP06          |
| US-32         | Aprobar Producto             | Como coordinador quiero aprobar productos tras inspección para autorizar uso.                      | Given producto aprobado por inspector, When coordinador valida, Then cambia estado y notifica investigador; Cuando correciones validadas, producto aprobado.                                             | EP06          |
